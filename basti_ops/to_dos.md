...
* draw polygon tool
  ...
  * ~~check face normal against view direction and flip~~
  * ~~when cancel: delete new object in object mode and reestablish selection~~
  * ~~add "plane" origin: cursor, origin, pivot .. focal point?~~
  * ~~add "plane" override~~
  * ~~define and stick with plane~~
  * ~~add vertex position tweaking~~
